            ...
            <div class="col-lg-6 side-left">
                <div class="card mb-6">
                    <div class="card-body avatar">
                        ...
                        <p class="name">{{$student_description_profile->student_fname}}</p>
                        <p class="designation">-  {{$student_description_profile->student_surname}}  -</p>
                    ...
                    <div class="card-body overview">
                        ...
                        <div class="info-links">
                            ...
                            <a class="website" >
                                ...
                                <span>{{$student_description_profile->student_birthdate}}</span>
                            </a>
